...
function SortableChapter({ chapter, index, activeChapterId, setActiveChapterId, setActiveLessonId, lessonId, onDelete }: any) {
  ...
  return (
    <li
      ref={setNodeRef}
      style={style}
      className={`rounded px-2 py-1 transition-all cursor-pointer group/chapter flex items-center ${chapter.id === activeChapterId ? "bg-primary/20 text-primary font-semibold" : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"}`}
      onClick={e => {
        e.stopPropagation();
            ...
            <div className="h-full flex flex-col">
              <div className="flex-1 overflow-y-auto p-4">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="mb-4 w-full hover:bg-primary dark:hover:bg-primary hover:text-primary-foreground dark:hover:text-primary-foreground"
                  onClick={() => {
